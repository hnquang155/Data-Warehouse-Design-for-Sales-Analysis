...
SELECT @dtStartDate = '1/1/2014'
SELECT @dtEndDate = '12/31/2014'
...
SELECT @dtStartDate = (SELECT StartDate FROM GroupDW.dbo.FROM_TO_DATE)
SELECT @dtEndDate =  (SELECT EndDate FROM GroupDW.dbo.FROM_TO_DATE)

Insert into  GroupDW.dbo.STAGE_ORDERS(CustomerID_ST, Sales_ST, Quantity_ST, Discount_ST, Profit_ST, ShippingCost_ST,
